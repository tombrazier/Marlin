...
#define __TMC_SW_SPI_DEFINE(IC, ST, L, AI) TMCMarlin<IC##Stepper, L, AI> stepper##ST(ST##_CS_PIN, float(ST##_RSENSE), TMC_SPI_MOSI, TMC_SPI_MISO, TMC_SPI_SCK, ST##_CHAIN_POS)
#define __TMC_HW_SPI_DEFINE(IC, ST, L, AI) TMCMarlin<IC##Stepper, L, AI> stepper##ST(ST##_CS_PIN, float(ST##_RSENSE), ST##_CHAIN_POS)
...
#define _TMC_HW_SPI_DEFINE(IC, ST, AI) __TMC_HW_SPI_DEFINE(IC, ST, TMC_##ST##_LABEL, AI)
#define _TMC_SW_SPI_DEFINE(IC, ST, AI) __TMC_SW_SPI_DEFINE(IC, ST, TMC_##ST##_LABEL, AI)

#define TMC_HW_SPI_DEFINE(ST, AI) _TMC_HW_SPI_DEFINE(ST##_DRIVER_TYPE, ST, AI##_AXIS)
#define TMC_SW_SPI_DEFINE(ST, AI) _TMC_SW_SPI_DEFINE(ST##_DRIVER_TYPE, ST, AI##_AXIS)
...
#define TMC_UART_DEFINE(SWHW, ST, AI) _TMC_UART_DEFINE(SWHW, ST##_DRIVER_TYPE, ST, AI##_AXIS)
  ...
  #define TMC_HW_SPI_DEFINE_E(AI) TMC_HW_SPI_DEFINE(E##AI, E##AI)
  #define TMC_SW_SPI_DEFINE_E(AI) TMC_SW_SPI_DEFINE(E##AI, E##AI)
  #define TMC_UART_DEFINE_E(SWHW, AI) TMC_UART_DEFINE(SWHW, E##AI, E##AI)
#else
  #define TMC_SPI_DEFINE_E(AI) TMC_SPI_DEFINE(E##AI, E)
  #define TMC_HW_SPI_DEFINE_E(AI) TMC_HW_SPI_DEFINE(E##AI, E)
  #define TMC_SW_SPI_DEFINE_E(AI) TMC_SW_SPI_DEFINE(E##AI, E)
