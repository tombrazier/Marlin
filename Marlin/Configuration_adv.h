...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  25.5        // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  22.0        // (Hz) The default dominant resonant frequency on the Y axis.
...
#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_DISTANCE_MM { 0.1, 0.1, 0.03 } // (linear=mm, rotational=°) One value for each linear axis
