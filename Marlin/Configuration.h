 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 5.54f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.229f  }       // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.056f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.07f }   // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200.0/40.0/1.1 * 16, 200.0/40.0*(25.0/25.4) * 16, 96.0/18.0*54.0/27.0*62.0/28.0 * 16, 200.0*68/7/22.5 * 8 }
#elif ENABLED(VDE_100)
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200.0/40.0/1.1 * 16, 200.0/40.0*(25.0/25.4) * 16, 96.0/18.0*54.0/27.0*62.0/28.0 * 16, 200.0/1.45 * 4 }
#else
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200.0/40.0/1.1 * 16, 200.0/40.0*(25.0/25.4) * 16, 96.0/18.0*54.0/27.0*62.0/28.0 * 16, 200.0/22.5 * 16 }
#endif
...
#define CLASSIC_JERK
  ...
  //#define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 100, 100, 10, 20 } // ...or, set your own edit limits
  #endif
#endif
 ...
 */
#define Z_MIN_PROBE_PIN 19 // Use Z Max pin (as it is interrupt capable - although softwareserial mucks that up!)
...
#define HOMING_FEEDRATE_MM_M { (30*60), (45*60), (5*60) }
