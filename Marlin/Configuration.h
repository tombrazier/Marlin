...
#define LULZBOT_FW_VERSION "2.1.3.0.7"
 ...
 */
  ...
  #define SWITCHING_NOZZLE_SERVO_ANGLES LULZBOT_SWITCHING_NOZZLE_SERVO_ANGLES  // A pair of angles for { E0, E1 }.
 ...
 */
#if ANY(Workhorse, TAZ6, TAZPro, TAZProXT) // Set Max Bed Power to 90% for a safety margin on the 15A fuse.
