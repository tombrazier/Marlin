...
#define LULZBOT_FW_VERSION "2.1.3.0.29"
...
// The size of the printable area
  ...
  #define LULZBOT_Z_MAX_POS 297
    ...
    #define LULZBOT_X_MAX_POS 286 // <-- changed
...
#else
  #define LULZBOT_BLTOUCH_ADAPTER_OFFSET 0
#endif
...
#define Y_MAX_POS (LULZBOT_Y_MAX_POS + LULZBOT_TOOLHEAD_Y_MAX_ADJ + LULZBOT_BLTOUCH_ADAPTER_OFFSET)
#define Y_MIN_POS (LULZBOT_Y_MIN_POS + LULZBOT_TOOLHEAD_Y_MIN_ADJ + LULZBOT_BLTOUCH_ADAPTER_OFFSET)
