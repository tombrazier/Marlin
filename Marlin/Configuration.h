 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 19.09f }          // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.253f  }       // (K/s per ∆K) Rate of change of sensor temperature from heat block.
