...
//TAZ 6 Single Extruder (W)
  ...
  // MET175 Tool head (50W)
    #define MET175_DEFAULT_Kp 15.35
    #define MET175_DEFAULT_Ki 1.05
    #define MET175_DEFAULT_Kd 56.00
  ...
  // MET285 Tool head (50W)
    #define MET285_DEFAULT_Kp 15.73
    #define MET285_DEFAULT_Ki 1.19
    #define MET285_DEFAULT_Kd 55.18
